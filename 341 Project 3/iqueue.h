...
private:
    ...
    void setPriorityFn(Node*& pos, Node* array[], int& increment);

   

    Node* mergeWithQueue(Node* crop1, Node* crop2);

    Node* copy(Node* crop, Node* copyCrop);

    Node* equals(Node* crop, Node* copyCrop);
};
#endif